...
export default function SignupPage() {
    ...
    return (
        <div className="h-[calc(100vh-56px)] bg-surface-0 flex flex-col lg:flex-row overflow-hidden">
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 relative z-10 bg-surface-0 overflow-y-auto">
                ...
                >
                    <div className="text-center md:text-left mb-10 mt-8 lg:mt-0">
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-surface-1 border border-stroke mb-4 text-emerald md:hidden">
                            <UserPlus className="w-5 h-5" />
                        </div>
                        <h1 className="text-4xl font-display font-bold text-text-0 tracking-tight mb-3">
                            Join <span className="text-emerald">Traceon</span>
                        </h1>
                        <p className="text-text-2 mb-6">
                            Create your account to start mapping your code
                        </p>
                    ...
                    <p className="text-center text-sm text-text-3 mt-4 mb-4">
                        Already have an account? <Link href="/login" className="text-emerald hover:text-emerald/80 transition-colors font-medium">Sign in</Link>
                    </p>
                </motion.div>
            </div>
        </div>
